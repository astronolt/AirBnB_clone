...
class TestReview(unittest.TestCase):
    ...
    def test_init_dict(self):
        ...
        test_dict = {'updated_at': datetime(1963, 11, 22, 12, 30, 00, 716921).isoformat(
            'T'), 'id': 'z3854b62-93fa-fbbe-27de-630706f8313c', 'created_at': datetime(1963, 11, 22, 12, 30, 00, 716921).isoformat('T')}
        ...
        self.assertTrue(rm2.created_at.isoformat('T')
                        == test_dict['created_at'])
        self.assertIsInstance(rm2.updated_at, datetime)
        self.assertTrue(rm2.updated_at.isoformat('T')
